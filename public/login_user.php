...
<body>
	...
	<div class="row">
            <div class="col-md-6">
                <p class="h4"><b>Jorge Amado</b></p>
                <p class="h5"><small>Estudante</small></p>
                <p>Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing  layouts and visual mockups.
	...
	<div class="row pt-5">
            <div class="col-md-6">
                <p class="display-4 font-weight-bold">Seja bem-vindo,</p>
                    <p class="display-4 mb-5 font-weight-bold">o que deseja fazer?</p>
                    <div class="row justify-content-initial">
                        ...
                        <p class="f-16 mt-5">I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                    </div>
            </div>
            <div class="col-md-6 justify-content-center">
                <img class="w-100 d-sm-none d-md-block d-none d-sm-block d-md-none d-lg-block" src="https://i.ibb.co/j86sfN7/image-1.png">
            </div>
        </div>
    </div>
    </section>
